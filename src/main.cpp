...
#if defined(NDEBUG)
#error "CoinClix cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uCLX) are considered zero fee (for relaying and mining)
...
{
    RenameThread("coinclix-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // CLX: We use certain sporks during IBD, so check to see if they are
