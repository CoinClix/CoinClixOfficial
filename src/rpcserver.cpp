...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CoinClix server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CoinClix server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CoinClix features */
        {"coinclix", "masternode", &masternode, true, true, false},
        {"coinclix", "listmasternodes", &listmasternodes, true, true, false},
        {"coinclix", "getmasternodecount", &getmasternodecount, true, true, false},
        {"coinclix", "masternodeconnect", &masternodeconnect, true, true, false},
        {"coinclix", "masternodecurrent", &masternodecurrent, true, true, false},
        {"coinclix", "masternodedebug", &masternodedebug, true, true, false},
        {"coinclix", "startmasternode", &startmasternode, true, true, false},
        {"coinclix", "createmasternodekey", &createmasternodekey, true, true, false},
        {"coinclix", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"coinclix", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"coinclix", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"coinclix", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"coinclix", "getmasternodescores", &getmasternodescores, true, true, false},
        {"coinclix", "mnbudget", &mnbudget, true, true, false},
        {"coinclix", "preparebudget", &preparebudget, true, true, false},
        {"coinclix", "submitbudget", &submitbudget, true, true, false},
        {"coinclix", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"coinclix", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"coinclix", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"coinclix", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"coinclix", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"coinclix", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"coinclix", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"coinclix", "checkbudgets", &checkbudgets, true, true, false},
        {"coinclix", "mnsync", &mnsync, true, true, false},
        {"coinclix", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> coinclix-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1142/\n";
}
