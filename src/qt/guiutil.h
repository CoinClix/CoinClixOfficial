...
/** Utility functions used by the CoinClix Qt UI.
 */
namespace GUIUtil
{
...
// Render CLX addresses in monospace font
...
// Parse "coinclix:" URI into recipient object, return true on successful parsing
