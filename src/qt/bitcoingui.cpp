                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CoinClix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CLX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and coinclix: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CoinClix Core"), this);
    aboutAction->setStatusTip(tr("Show information about CoinClix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CoinClix"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CLX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CLX addresses"));
    ...
    openAction->setStatusTip(tr("Open a coinclix: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CoinClix Core help message to get a list with possible CoinClix command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CoinClix Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the CoinClix network", "", count));
}
...
{
    QString strTitle = tr("CoinClix Core"); // default title
