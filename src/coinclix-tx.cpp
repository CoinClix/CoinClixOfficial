...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CoinClix Core coinclix-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  coinclix-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded coinclix transaction") + "\n" +
                               "  coinclix-tx [options] -create [commands]   " + _("Create hex-encoded coinclix transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded coinclix transaction
