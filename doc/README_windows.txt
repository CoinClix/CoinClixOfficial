...
Intro
-----
CoinClix (CLX) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. CoinClix utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run coinclix-qt.exe.

CoinClix Core is the original CoinClix client and it builds the backbone of the network.
However, it downloads and stores the entire history of CoinClix transactions;
