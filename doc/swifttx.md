...
This mechanism has been integrated into Bitcore-Node-CoinClix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/coinclix/insight-api-coinclix#web-socket-api](https://github.com/coinclix/insight-api-coinclix#web-socket-api)
* API: [https://github.com/coinclix/insight-api-coinclix#swifttx-transactions](https://github.com/coinclix/insight-api-coinclix#swifttx-transactions)
...
By default, the CoinClix Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CoinClix Core daemon:
