Contributing to CoinClix Core
==================================

The CoinClix Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CoinClix Core project, and is not to be
confused with overall CoinClix Network Protocol consensus changes.

Whether a pull request is merged into CoinClix Core rests with the project merge
...
Patches that change CoinClix consensus rules are considerably more involved than
...
Where a patch set proposes to change the CoinClix consensus, it must have been
...
The project lead is the release manager for each CoinClix Core release.
