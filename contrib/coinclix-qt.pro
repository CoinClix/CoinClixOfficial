...
RESOURCES += src/qt/coinclix.qrc src/qt/coinclix_locale.qrc

TRANSLATIONS += src/qt/locale/coinclix_bg.ts \
                src/qt/locale/coinclix_de.ts \
                src/qt/locale/coinclix_en.ts \
                src/qt/locale/coinclix_es.ts \
                src/qt/locale/coinclix_fi.ts \
                src/qt/locale/coinclix_fr.ts \
                src/qt/locale/coinclix_it.ts \
                src/qt/locale/coinclix_ja.ts \
                src/qt/locale/coinclix_pl.ts \
                src/qt/locale/coinclix_pt.ts \
                src/qt/locale/coinclix_ru.ts \
                src/qt/locale/coinclix_sk.ts \
                src/qt/locale/coinclix_sv.ts \
                src/qt/locale/coinclix_vi.ts \
                src/qt/locale/coinclix_zh_CN.ts \
                src/qt/locale/coinclix_zh_TW.ts
