...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='coinclix.conf'
CONFIGFOLDER='/root/.coinclix'
COIN_DAEMON='coinclixd'
COIN_CLI='coinclix-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/CoinClix/CoinClix/releases/download/v1.0.0/coinclix-1.0.0-x86_64-linux-gnu.tar.gz'
